...
import { ContextMenu, Dialog } from "@base-ui-components/react";
...
export function CustomAlbum({
  ...
  const { setAlbum, setTextBackground, setTextColor } = useContext(GridContext);
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed top-1/2 left-1/2 -mt-8 min-w-96 w-1/3 max-w-[calc(100vw-3rem)] -translate-x-1/2 -translate-y-1/2 bg-neutral-950 p-4 text-white outline outline-neutral-700 transition-all duration-150 data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 dark:outline-neutral-700">
